...
> 分发链路 —— 用户从源站自取。见 `docs/audit-findings.md` F0-09。

---

## 应用图标 —— **不在 GPL 授权范围内**

涉及文件:`icons/app_icon.png`、`assets/app_icon.png`、
`android/app/src/main/res/mipmap-*/ic_launcher.png`。

图像本身由本项目作者绘制,**但画面中的角色形象源自第三方游戏作品**,
其角色设计的权利属于该作品的权利人。因此该图标:

- **保留所有权利**,不随本项目的 GPL-3.0 一同授权;
- fork / 二次分发本项目时**请自行替换图标**,不要连同原图一并分发;
- 与该游戏的权利人无关联、未获其授权或背书。

代码仓库的 GPL-3.0 授权只覆盖源代码,不覆盖任何美术资源 —— 这是两件独立的事。
